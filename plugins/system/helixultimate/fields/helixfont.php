...
class JFormFieldHelixfont extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $html .= '<label><small>'. \JText::_('Fuente') .'</small></label>';
        ...
        $html .= '<optgroup label="'. \JText::_('Fuente Google') .'">';
        ...
        $html .= '<label><small>'. \JText::_('Tamaño de Fuente') .'</small></label>';
        ...
        $html .= '<label><small>'. \JText::_('Ancho Fuente') .'</small></label>';
        $html .= '<select class="helix-ultimate-webfont-weight-list">';
        $html .= '<option value="">'. \JText::_('Seleccionar Fuente') .'</option>';
        ...
        $html .= '<label><small>'. \JText::_('Stylo de Fuente') .'</small></label>';
        ...
        $html .= '<label><small>'. \JText::_('Conjunto de Fuente') .'</small></label>';
        $html .= '<select class="helix-ultimate-webfont-subset-list">';
        $html .= '<option value="">'. \JText::_('Seleccionar') .'</option>';
